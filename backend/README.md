...
- `DATABASE_URL` or individual database parameters (`DATABASE_HOST`, `DATABASE_PORT`, `DATABASE_NAME`, `DATABASE_USER`, `DATABASE_PASSWORD`)
...
Configure your PostgreSQL database connection using either:
- A single `DATABASE_URL` connection string, or
- Individual connection parameters (`DATABASE_HOST`, `DATABASE_PORT`, `DATABASE_NAME`, `DATABASE_USER`, `DATABASE_PASSWORD`)
